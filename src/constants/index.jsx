...
export const features = [
    {
      ...
      description: "All your bank accounts, spending, savings, and investments in one place.",
      bgColor: "bg-[#EAE2FF]",
      icon: "📊", // Replace with actual icons
    },
    {
      title: "AI-DRIVEN INSIGHTS",
      description: "Get smart recommendations to curb impulse spending, boost savings, and optimize investments.",
      bgColor: "bg-[#FFD6EB]",
      icon: "✨",
    },
    {
      title: "AUTOMATED FINANCIAL TOOLS",
      description: "Set budgets, track expenses, and auto-allocate funds to high-return opportunities.",
      bgColor: "bg-[#C5B3FF]",
      icon: "🔄",
    },
    {
      title: "THE X SCORE",
      description: "A snapshot of your financial health that shows you exactly where you stand and how to level up.",
      bgColor: "bg-[#DCCAFF]",
      icon: "💜",
    },
  ];
...
export const questions = [
    {
      question: "When you receive unexpected money, like a bonus/gift, what do you typically do with it?",
      options: [
        "Save it for future use",
        "Spend it on something you want.",
        "Invest it to grow your wealth.",
        "Donate it to charity or help others."
      ]
    },
    {
